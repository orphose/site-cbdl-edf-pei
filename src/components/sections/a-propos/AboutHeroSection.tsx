 ...
 * Producteur d'électricité insulaire responsable
 */
    ...
    <section className="relative min-h-[85vh] flex items-center bg-edf-blue overflow-hidden pt-[100px]">
      ...
      <div className="container-custom relative z-10 py-20">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-edf-orange">dernière génération</span>{" "}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 overflow-hidden">
        <motion.div
          ...
          style={{
            background: "linear-gradient(90deg, #FFB210, #88D910, #001A70, #FFB210, #88D910, #001A70)",
          }}
          animate={{
            x: ["-50%", "0%"],
          }}
