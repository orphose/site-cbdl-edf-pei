...
/**
 * Section Hero - Page Bénéfices
 * Au cœur des défis du péyi Guyane
 */
    ...
    <section className="relative min-h-[85vh] flex items-center bg-edf-blue overflow-hidden pt-[100px]">
      ...
      <div className="container-custom relative z-10 py-20">
        <div className="max-w-4xl">
          ...
          >
            Au cœur des{" "}
            <span className="text-edf-orange font-semibold">défis</span>{" "}
            du{" "}
            <span className="text-edf-green font-semibold">péyi</span>{" "}
            Guyane
          </motion.h2>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 overflow-hidden">
        <motion.div
          ...
          style={{
            background: "linear-gradient(90deg, #88D910, #00d4ff, #001A70, #88D910, #00d4ff, #001A70)",
          }}
          animate={{
            x: ["-50%", "0%"],
          }}
